...
import static com.ymitcloud.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class WxPubPayClient extends AbstractWxPayClient {
    ...
    protected PayOrderRespDTO doUnifiedOrderV2(PayOrderUnifiedReqDTO reqDTO) throws WxPayException {
        ...
        // 转换结果
        return PayOrderRespDTO.waitingOf(PayOrderDisplayModeEnum.APP.getMode(), JsonUtils.toJsonString(response),
