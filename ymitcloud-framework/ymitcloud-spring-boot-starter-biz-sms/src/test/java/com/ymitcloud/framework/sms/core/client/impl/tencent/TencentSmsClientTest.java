package com.ymitcloud.framework.sms.core.client.impl.tencent;
...
public class TencentSmsClientTest extends BaseMockitoUnitTest {
    ...
    public void testDoSendSms_success() throws Throwable {
        ...
        when(client.SendSms(argThat(request -> {
            ...
            Assertions.assertEquals(JsonUtils.toJsonString(ArrayUtils.toArray(new ArrayList<>(MapUtils.convertMap(templateParams).values()), String::valueOf)),
                    JsonUtils.toJsonString(request.getTemplateParamSet()));
