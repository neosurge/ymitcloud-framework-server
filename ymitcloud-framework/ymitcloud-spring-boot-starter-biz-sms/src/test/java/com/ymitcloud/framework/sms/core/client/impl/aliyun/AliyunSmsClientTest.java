package com.ymitcloud.framework.sms.core.client.impl.aliyun;

import cn.hutool.core.util.ReflectUtil;
import com.ymitcloud.framework.common.core.KeyValue;
import com.ymitcloud.framework.common.util.collection.MapUtils;
import com.ymitcloud.framework.sms.core.client.dto.SmsReceiveRespDTO;
import com.ymitcloud.framework.sms.core.client.dto.SmsSendRespDTO;
...
public class AliyunSmsClientTest extends BaseMockitoUnitTest {
    ...
    public void tesSendSms_success() throws Throwable {
        ...
        when(client.getAcsResponse(argThat((ArgumentMatcher<SendSmsRequest>) acsRequest -> {
            ...
            Assertions.assertEquals(JsonUtils.toJsonString(MapUtils.convertMap(templateParams)), acsRequest.getTemplateParam());
    ...
    public void tesSendSms_fail() throws Throwable {
        ...
        List<KeyValue<String, Object>> templateParams = Lists.newArrayList(
                new KeyValue<>("code", 1234), new KeyValue<>("op", "login"));
        // mock 方法
        SendSmsResponse response = RandomUtils.randomPojo(SendSmsResponse.class, o -> o.setCode("ERROR"));
        when(client.getAcsResponse(argThat((ArgumentMatcher<SendSmsRequest>) acsRequest -> {
            assertEquals(mobile, acsRequest.getPhoneNumbers());
            assertEquals(properties.getSignature(), acsRequest.getSignName());
            assertEquals(apiTemplateId, acsRequest.getTemplateCode());
