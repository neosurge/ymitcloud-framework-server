...
public class S3FileClientTest {
    ...
    public void testAliyun() throws Exception {
        ...
        config.setBucket("ymitcloud-aoteman");
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://ali-oss.ymitcloud.com
    ...
    public void testQCloud() throws Exception {
        ...
        config.setDomain(null); // 如果有自定义域名，则可以设置。http://tengxun-oss.ymitcloud.com
...
//        config.setAccessSecret(System.getenv("QINIU_SECRET_KEY"));
        ...
        config.setBucket("ymitcloud");
        config.setDomain("http://test.ymitcloud.com"); 
