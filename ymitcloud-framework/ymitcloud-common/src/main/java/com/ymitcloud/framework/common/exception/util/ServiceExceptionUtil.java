package com.ymitcloud.framework.common.exception.util;
 ...
 *
 * 1. 异常提示信息，写在枚举类中，例如说，com.ymitcloud.oceans.user.api.constants.ErrorCodeEnum 类 + ServiceExceptionConfiguration
