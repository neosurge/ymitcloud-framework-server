package com.ymitcloud.framework.datapermission.core.db;
    ...
    public void setUp() {
        ...
        DataPermissionRule tenantRule = new DataPermissionRule() {
            ...
            public Set<String> getTableNames() {
                return SetUtils.asSet("entity", "entity1", "entity2", "entity3", "t1", "t2", "sys_dict_item", // 支持 MyBatis Plus 的单元测试
        ...
        DataPermissionRule deptRule = new DataPermissionRule() {
            ...
            @Override
            public Set<String> getTableNames() {
                return SetUtils.asSet("t_user");  // 满足自己的单元测试
            }
