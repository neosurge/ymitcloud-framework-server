package com.ymitcloud.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${ymitcloud.websocket.sender-rocketmq.topic}",
        consumerGroup = "${ymitcloud.websocket.sender-rocketmq.consumer-group}",
