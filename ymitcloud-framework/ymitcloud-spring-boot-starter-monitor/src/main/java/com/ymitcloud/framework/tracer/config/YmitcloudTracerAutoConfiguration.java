...
import com.ymitcloud.framework.tracer.core.aop.BizTraceAspect;
import com.ymitcloud.framework.tracer.core.filter.TraceFilter;
...
@ConditionalOnProperty(prefix = "ymitcloud.tracer", value = "enable", matchIfMissing = true)
public class YmitcloudTracerAutoConfiguration {
