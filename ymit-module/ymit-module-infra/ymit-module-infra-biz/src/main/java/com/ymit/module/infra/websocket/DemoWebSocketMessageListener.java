package com.ymit.module.infra.websocket;
...
import com.ymit.module.infra.websocket.message.DemoReceiveMessage;
import com.ymit.module.infra.websocket.message.DemoSendMessage;
...
public class DemoWebSocketMessageListener implements WebSocketMessageListener<DemoSendMessage> {
    ...
    public void onMessage(WebSocketSession session, DemoSendMessage message) {
        ...
        if (message.getToUserId() != null) {
            ...
            this.webSocketMessageSender.sendObject(UserTypeEnum.ADMIN.getValue(), message.getToUserId(), // 给指定用户
        ...
        this.webSocketMessageSender.sendObject(UserTypeEnum.ADMIN.getValue(), // 给所有用户
                "demo-message-receive", toMessage);
    }
