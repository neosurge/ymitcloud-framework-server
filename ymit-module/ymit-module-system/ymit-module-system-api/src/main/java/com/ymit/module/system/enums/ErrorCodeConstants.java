package com.ymit.module.system.enums;
...
public interface ErrorCodeConstants {
    ...
    ErrorCode AREA_EXITS_CHILDREN = new ErrorCode(1_002_029_002, "存在存在子行政区划，无法删除");
    ErrorCode AREA_PARENT_NOT_EXITS = new ErrorCode(1_002_029_003, "父级行政区划不存在");
    ErrorCode AREA_PARENT_ERROR = new ErrorCode(1_002_029_004, "不能设置自己为父行政区划");
    ErrorCode AREA_NAME_DUPLICATE = new ErrorCode(1_002_029_005, "已经存在该区域名称的行政区划");
    ErrorCode AREA_PARENT_IS_CHILD = new ErrorCode(1_002_029_006, "不能设置自己的子Area为父Area");
