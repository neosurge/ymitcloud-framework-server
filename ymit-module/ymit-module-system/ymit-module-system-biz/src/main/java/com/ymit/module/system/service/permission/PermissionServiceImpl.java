package com.ymit.module.system.service.permission;
...
import com.ymit.module.system.dal.dataobject.permission.RoleMenuDO;
import com.ymit.module.system.dal.dataobject.permission.UserRoleDO;
import com.ymit.module.system.dal.mysql.permission.RoleMenuMapper;
import com.ymit.module.system.dal.mysql.permission.UserRoleMapper;
...
import static com.ymit.framework.common.util.json.JsonUtils.toJsonString;
...
public class PermissionServiceImpl implements PermissionService {
    ...
    @Caching(evict = {@CacheEvict(value = RedisKeyConstants.MENU_ROLE_ID_LIST, allEntries = true), // allEntries 清空所有缓存，此处无法方便获得 roleId 对应的 menu 缓存们
            @CacheEvict(value = RedisKeyConstants.USER_ROLE_ID_LIST, allEntries = true) // allEntries 清空所有缓存，此处无法方便获得 roleId 对应的 user 缓存们
    })
    ...
    public DeptDataPermissionRespDTO getDeptDataPermission(Long userId) {
        ...
        // 获得用户的部门编号的缓存，通过 Guava 的 Suppliers 惰性求值，既有且仅有第一次发起 DB 的查询
