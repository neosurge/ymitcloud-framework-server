...
import com.ymit.module.system.dal.mysql.permission.MenuMapper;
...
public class MenuServiceImpl implements MenuService {
    ...
    public List<MenuDO> getMenuList() {
        return menuMapper.selectList().stream().sorted((a, b) -> b.getSort() - a.getSort()).collect(Collectors.toList());
    }
    ...
    public List<MenuDO> getMenuList(Collection<Long> ids) {
        LambdaQueryWrapper<MenuDO> wrapper = new LambdaQueryWrapperX<MenuDO>()
                .in(MenuDO::getId, ids)
                .orderByDesc(MenuDO::getSort).orderByAsc(MenuDO::getId);
