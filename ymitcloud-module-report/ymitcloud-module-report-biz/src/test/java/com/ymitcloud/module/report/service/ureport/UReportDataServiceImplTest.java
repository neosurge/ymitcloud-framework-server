...
public class UReportDataServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateUReportData_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> uReportDataService.updateUReportData(updateReqVO), ErrorCodeConstants.UREPORT_DATA_NOT_EXISTS);
    }
    ...
    public void testDeleteUReportData_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> uReportDataService.deleteUReportData(id), ErrorCodeConstants.UREPORT_DATA_NOT_EXISTS);
    }
