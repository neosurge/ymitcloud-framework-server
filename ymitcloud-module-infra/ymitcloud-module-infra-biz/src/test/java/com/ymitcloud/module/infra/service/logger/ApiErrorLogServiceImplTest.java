package com.ymitcloud.module.infra.service.logger;
...
import com.ymitcloud.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.ymitcloud.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.ymitcloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.ymitcloud.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("ymitcloud-test");
        ...
        reqVO.setApplicationName("ymitcloud-test");
