package com.ymitcloud.module.infra.service.file;

import cn.hutool.core.date.DatePattern;
import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import com.ymitcloud.framework.common.pojo.PageResult;
import com.ymitcloud.framework.file.core.client.FileClient;
...
import com.ymitcloud.framework.file.core.client.local.LocalFileClient;
import com.ymitcloud.framework.file.core.client.local.LocalFileClientConfig;
import com.ymitcloud.framework.file.core.enums.FileStorageEnum;
...
import com.ymitcloud.module.infra.dal.mysql.file.FileConfigMapper;
import lombok.Data;
...
import static com.ymitcloud.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static com.ymitcloud.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.ymitcloud.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateFileConfig_success() {
        ...
        Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai")
                ...
                .put("domain", "https://www.ymitcloud.com").build();
        ...
        assertEquals("https://www.ymitcloud.com", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
    ...
    public void testUpdateFileConfig_success() {
        ...
        FileConfigDO dbFileConfig = randomPojo(FileConfigDO.class, o -> o.setStorage(FileStorageEnum.LOCAL.getStorage())
                ...
                .setConfig(new LocalFileClientConfig().setBasePath("/yunai").setDomain("https://www.ymitcloud.com")));
        ...
        FileConfigSaveReqVO reqVO = randomPojo(FileConfigSaveReqVO.class, o -> {
            ...
            Map<String, Object> config = MapUtil.<String, Object>builder().put("basePath", "/yunai2")
                    ...
                    .put("domain", "https://doc.ymitcloud.com").build();
        ...
        assertEquals("https://doc.ymitcloud.com", ((LocalFileClientConfig) fileConfig.getConfig()).getDomain());
    ...
    public void testUpdateFileConfigMaster_success() {
        ...
        // 断言数据
        Assertions.assertTrue(fileConfigMapper.selectById(dbFileConfig.getId()).getMaster());
        Assertions.assertFalse(fileConfigMapper.selectById(masterFileConfig.getId()).getMaster());
        // 验证 cache
    ...
    public void testGetFileConfigPage() {
        ...
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("云码源码")
    ...
    public void testFileConfig() throws Exception {
        ...
        when(fileClient.upload(any(), any(), any())).thenReturn("https://www.ymitcloud.com");

        // 调用，并断言
        assertEquals("https://www.ymitcloud.com", fileConfigService.testFileConfig(id));
