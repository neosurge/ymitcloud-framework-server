package com.ymitcloud.module.infra.service.codegen;
...
import com.ymitcloud.module.infra.dal.mysql.codegen.CodegenColumnMapper;
import com.ymitcloud.module.infra.dal.mysql.codegen.CodegenTableMapper;
import com.ymitcloud.module.infra.enums.codegen.CodegenFrontTypeEnum;
import com.ymitcloud.module.infra.enums.codegen.CodegenSceneEnum;
import com.ymitcloud.module.infra.enums.codegen.CodegenTemplateTypeEnum;
import com.ymitcloud.module.infra.framework.codegen.config.CodegenProperties;
import com.ymitcloud.module.infra.service.codegen.inner.CodegenBuilder;
import com.ymitcloud.module.infra.service.codegen.inner.CodegenEngine;
import com.ymitcloud.module.infra.service.db.DatabaseTableService;
...
import static com.ymitcloud.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
...
import static com.ymitcloud.module.infra.enums.ErrorCodeConstants.*;
...
public class CodegenServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateCodegenList() {
        ...
        when(tableInfo.getComment()).thenReturn("云码");
        ...
        Assertions.assertEquals(CodegenSceneEnum.ADMIN.getScene(), dbTable.getScene());
    ...
    public void testGenerationCodes_one_success() {
        ...
        when(codegenEngine.execute(eq(table), argThat(columns -> {
            ...
            Assertions.assertEquals(column01, columns.get(0));
            Assertions.assertEquals(column02, columns.get(1));
            return true;
    ...
    public void testGetDatabaseTableList() {
        ...
        assertEquals("云码", result.get(0).getComment());
