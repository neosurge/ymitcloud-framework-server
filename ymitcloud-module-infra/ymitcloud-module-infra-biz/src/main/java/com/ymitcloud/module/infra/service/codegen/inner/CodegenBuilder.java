...
import com.ymitcloud.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import com.ymitcloud.module.infra.enums.codegen.CodegenColumnListConditionEnum;
...
public class CodegenBuilder {
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.ymitcloud.com");
            return;
        }
        // reason
