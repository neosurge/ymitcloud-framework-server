package com.ymitcloud.module.mp.service.message;
...
import com.ymitcloud.module.mp.dal.mysql.message.MpMessageMapper;
import com.ymitcloud.module.mp.enums.message.MpMessageSendFromEnum;
...
import static com.ymitcloud.module.mp.enums.ErrorCodeConstants.MESSAGE_SEND_FAIL;
