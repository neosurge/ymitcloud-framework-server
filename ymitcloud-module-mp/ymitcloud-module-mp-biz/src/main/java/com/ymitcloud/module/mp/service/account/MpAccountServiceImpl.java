package com.ymitcloud.module.mp.service.account;
...
import com.ymitcloud.module.mp.dal.mysql.account.MpAccountMapper;
import com.ymitcloud.module.mp.enums.ErrorCodeConstants;
...
import static com.ymitcloud.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 ymitcloud-module-mp - 表结构未导入][参考 https://doc.ymitcloud.com/mp/build/ 开启]");
