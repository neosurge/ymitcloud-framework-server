package com.ymit.framework.operatelog.core.aop;
...
import com.ymit.framework.operatelog.core.service.OperateLog;
...
/**
 * 拦截使用 @OperateLog 注解，如果满足条件，则生成操作日志。 满足如下任一条件，则会进行记录：
 * <p>
...
public class OperateLogAspect {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(OperateLogAspect.class);
    /**
     * 用于记录操作内容的上下文
     *
    ...
    public OperateLogAspect(OperateLogFrameworkService operateLogFrameworkService) {
    ...
    private static void fillModuleFields(OperateLog operateLogObj, ProceedingJoinPoint joinPoint, com.ymit.framework.operatelog.core.annotations.OperateLog operateLog) {
        // module 属性
        if (operateLog != null) {
    ...
    private static void fillMethodFields(OperateLog operateLogObj, ProceedingJoinPoint joinPoint, com.ymit.framework.operatelog.core.annotations.OperateLog operateLog, LocalDateTime startTime, Object result, Throwable exception) {
    ...
    private static boolean isLogEnable(ProceedingJoinPoint joinPoint, com.ymit.framework.operatelog.core.annotations.OperateLog operateLog) {
        // 有 @OperateLog 注解的情况下
        if (operateLog != null) {
    ...
    @Around("@annotation(com.ymit.framework.operatelog.core.annotations.OperateLog) && @annotation(operateLog)")
    public Object around(ProceedingJoinPoint joinPoint, com.ymit.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return this.around0(joinPoint, operateLog);
    }

    private Object around0(ProceedingJoinPoint joinPoint, com.ymit.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
    ...
    private void log(ProceedingJoinPoint joinPoint, com.ymit.framework.operatelog.core.annotations.OperateLog operateLog, LocalDateTime startTime, Object result, Throwable exception) {
        try {
            // 判断不记录的情况
    ...
    private void log0(ProceedingJoinPoint joinPoint, com.ymit.framework.operatelog.core.annotations.OperateLog operateLog, LocalDateTime startTime, Object result, Throwable exception) {
