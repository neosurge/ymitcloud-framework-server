package com.ymit.framework.ip.core.utils;
...
public class AreaUtils {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(AreaUtils.class);
    /**
     * Area 内存缓存，提升访问速度
     */
    ...
    public static String format(Integer id, String separator) {
        ...
        for (int i = 0; i < AreaTypeEnum.values().length; i++) { // 避免死循环
            ...
            // “递归”父节点
            area = area.getParent();
            if (area == null || ObjectUtils.equalsAny(area.getId(), Area.ID_GLOBAL, Area.ID_CHINA)) { // 跳过父节点为中国的情况
                break;
            }
