...
import com.ymit.framework.web.core.filter.CacheRequestBodyFilter;
import com.ymit.framework.web.core.handler.GlobalExceptionHandler;
import com.ymit.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class YmitWebAutoConfiguration implements WebMvcConfigurer {
    ...
    public YmitWebAutoConfiguration(@Autowired Environment _env, @Autowired WebProperties _webProperties) {
        this.env = _env;
        this.webProperties = _webProperties;
    }
    ...
    public GlobalExceptionHandler globalExceptionHandler(ApiErrorLogFrameworkService apiErrorLogFrameworkService) {
        return new GlobalExceptionHandler(apiErrorLogFrameworkService, this.env);
    }
