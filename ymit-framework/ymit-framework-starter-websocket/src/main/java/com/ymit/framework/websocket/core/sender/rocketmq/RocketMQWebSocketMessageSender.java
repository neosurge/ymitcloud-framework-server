...
public class RocketMQWebSocketMessageSender extends AbstractWebSocketMessageSender {
    ...
    public void send(Integer userType, Long userId, String messageType, String messageContent) {
        this.sendRocketMQMessage(null, userId, userType, messageType, messageContent);
    }

    @Override
    public void send(Integer userType, String messageType, String messageContent) {
        this.sendRocketMQMessage(null, null, userType, messageType, messageContent);
    }

    @Override
    public void send(String sessionId, String messageType, String messageContent) {
        this.sendRocketMQMessage(sessionId, null, null, messageType, messageContent);
    }
    ...
    private void sendRocketMQMessage(String sessionId, Long userId, Integer userType, String messageType, String messageContent) {
        ...
        this.rocketMQTemplate.syncSend(this.topic, mqMessage);
    }
}
