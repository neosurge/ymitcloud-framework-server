...
public class RabbitMQWebSocketMessageSender extends AbstractWebSocketMessageSender {
    private final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(RabbitMQWebSocketMessageSender.class);
    ...
    public void send(Integer userType, Long userId, String messageType, String messageContent) {
        this.sendRabbitMQMessage(null, userId, userType, messageType, messageContent);
    }

    @Override
    public void send(Integer userType, String messageType, String messageContent) {
        this.sendRabbitMQMessage(null, null, userType, messageType, messageContent);
    }

    @Override
    public void send(String sessionId, String messageType, String messageContent) {
        this.sendRabbitMQMessage(sessionId, null, null, messageType, messageContent);
    }
    ...
    private void sendRabbitMQMessage(String sessionId, Long userId, Integer userType, String messageType, String messageContent) {
        ...
        this.rabbitTemplate.convertAndSend(this.topicExchange.getName(), null, mqMessage);
    }
}
