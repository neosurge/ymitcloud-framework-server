package com.ymit.framework.excel.core.convert;
...
public class DictConvert implements Converter<Object> {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DictConvert.class);
    ...
    public Object convertToJavaData(ReadCellData readCellData, ExcelContentProperty contentProperty, GlobalConfiguration globalConfiguration) {
        ...
        if (value == null) {
            log.error("[convertToJavaData][type({}) 解析不了 label({})]", type, label);
            return null;
        }
