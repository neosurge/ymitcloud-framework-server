package com.ymit.framework.common.util.http;
...
public class HttpUtils {
    ...
    public static String replaceUrlQuery(String url, String key, String value) {
        ...
        // 先移除
        TableMap<CharSequence, CharSequence> query = (TableMap<CharSequence, CharSequence>) ReflectUtil.getFieldValue(builder.getQuery(), "query");
        query.remove(key);
        // 后添加
