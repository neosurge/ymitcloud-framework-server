package com.ymit.framework.sms.core.client.impl.tencent;
...
import com.ymit.framework.common.util.collection.ArrayUtils;
...
public class TencentSmsClient extends AbstractSmsClient {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(TencentSmsClient.class);
    /**
     * REGION，使用南京
     */
    ...
    protected void doInit() {
        ...
        Credential credential = new Credential(this.getApiKey(), this.properties.getApiSecret());
        this.client = new SmsClient(credential, ENDPOINT);
    }

    private String getSdkAppId() {
        return StrUtil.subAfter(this.properties.getApiKey(), " ", true);
    }

    private String getApiKey() {
        return StrUtil.subBefore(this.properties.getApiKey(), " ", true);
    }
    ...
    public SmsSendRespDTO sendSms(Long sendLogId, String mobile,
        ...
        request.setSmsSdkAppId(this.getSdkAppId());
        ...
        return new SmsSendRespDTO()
                .setSuccess(Objects.equals(status.getCode(), API_CODE_SUCCESS))
                .setSerialNo(status.getSerialNo())
                .setApiRequestId(response.getRequestId())
                .setApiCode(status.getCode())
                .setApiMsg(status.getMessage());
    }
    ...
    public SmsTemplateRespDTO getSmsTemplate(String apiTemplateId) throws Throwable {
        ...
        // 执行请求
        DescribeSmsTemplateListResponse response = this.client.DescribeSmsTemplateList(request);
        DescribeTemplateListStatus status = response.getDescribeTemplateStatusSet()[0];
        if (status == null || status.getStatusCode() == null) {
            return null;
        }
        return new SmsTemplateRespDTO()
                .setId(status.getTemplateId().toString())
                .setContent(status.getTemplateContent())
                .setAuditStatus(this.convertSmsTemplateAuditStatus(status.getStatusCode().intValue()))
                .setAuditReason(status.getReviewReply());
    }
    ...
    static class SessionContext {
        ...
        public SessionContext setLogId(Long logId) {
            this.logId = logId;
            return this;
        }
    }
