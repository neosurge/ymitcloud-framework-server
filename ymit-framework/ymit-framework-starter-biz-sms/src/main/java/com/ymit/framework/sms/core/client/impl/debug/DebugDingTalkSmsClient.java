package com.ymit.framework.sms.core.client.impl.debug;
...
public class DebugDingTalkSmsClient extends AbstractSmsClient {
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(DebugDingTalkSmsClient.class);
    ...
    public SmsSendRespDTO sendSms(Long sendLogId, String mobile, String apiTemplateId, List<KeyValue<String, Object>> templateParams) {
        // 构建请求
        String url = this.buildUrl("robot/send");
        Map<String, Object> params = new HashMap<>();
        params.put("msgtype", "text");
        String content = String.format("【模拟短信】\n手机号：%s\n短信日志编号：%d\n模板参数：%s", mobile, sendLogId, MapUtils.convertMap(templateParams));
    ...
    private String buildUrl(String path) {
        ...
        // 生成 sign
        String secret = this.properties.getApiSecret();
        ...
        // 构建最终 URL
        return String.format("https://oapi.dingtalk.com/%s?access_token=%s&timestamp=%d&sign=%s", path, this.properties.getApiKey(), timestamp, sign);
    }
