...
public class CrmCustomerExcelVO {
    ...
    @DictFormat(com.ymitcloud.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_INDUSTRY)
    private Integer industryId;

    @ExcelProperty(value = "客户等级", converter = DictConvert.class)
    @DictFormat(com.ymitcloud.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_LEVEL)
    private Integer level;

    @ExcelProperty(value = "客户来源", converter = DictConvert.class)
    @DictFormat(com.ymitcloud.module.crm.enums.DictTypeConstants.CRM_CUSTOMER_SOURCE)
