package com.ymitcloud.module.pay.service.channel;
...
import com.ymitcloud.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import com.ymitcloud.framework.pay.core.client.impl.weixin.WxPayClientConfig;
...
import com.ymitcloud.module.pay.dal.mysql.channel.PayChannelMapper;
...
public class PayChannelServiceTest extends BaseDbUnitTest {
    ...
    public void testCreateChannel_exists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> channelService.createChannel(reqVO), ErrorCodeConstants.CHANNEL_EXIST_SAME_CHANNEL_ERROR);
    }
    ...
    public void testUpdateChannel_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> channelService.updateChannel(reqVO), ErrorCodeConstants.CHANNEL_NOT_FOUND);
    }
    ...
    public void testDeleteChannel_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> channelService.deleteChannel(id), ErrorCodeConstants.CHANNEL_NOT_FOUND);
    }
    ...
    public void testValidPayChannel_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> channelService.validPayChannel(id), ErrorCodeConstants.CHANNEL_NOT_FOUND);
    }
    ...
    public void testValidPayChannel_isDisable() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> channelService.validPayChannel(id), ErrorCodeConstants.CHANNEL_IS_DISABLE);
    }
