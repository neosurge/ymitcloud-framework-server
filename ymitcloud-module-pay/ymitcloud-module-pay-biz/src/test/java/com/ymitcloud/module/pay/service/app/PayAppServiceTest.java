package com.ymitcloud.module.pay.service.app;
...
import com.ymitcloud.module.pay.dal.mysql.app.PayAppMapper;
...
public class PayAppServiceTest extends BaseDbUnitTest {
    ...
    public void testCreateApp_success() {
        ...
        PayAppCreateReqVO reqVO = RandomUtils.randomPojo(PayAppCreateReqVO.class, o ->
                o.setStatus((RandomUtil.randomEle(CommonStatusEnum.values()).getStatus()))
                        .setOrderNotifyUrl(RandomUtils.randomURL())
                        .setRefundNotifyUrl(RandomUtils.randomURL()));
    ...
    public void testUpdateApp_success() {
        ...
        PayAppDO dbApp = RandomUtils.randomPojo(PayAppDO.class);
        appMapper.insert(dbApp);// @Sql: 先插入出一条存在的数据
        // 准备参数
        PayAppUpdateReqVO reqVO = RandomUtils.randomPojo(PayAppUpdateReqVO.class, o -> {
            o.setStatus(CommonStatusEnum.ENABLE.getStatus());
            o.setOrderNotifyUrl(RandomUtils.randomURL()).setRefundNotifyUrl(RandomUtils.randomURL());
    ...
    public void testUpdateAppStatus() {
        ...
        PayAppDO dbApp = RandomUtils.randomPojo(PayAppDO.class, o ->
    ...
    public void testAppMap() {
        ...
        PayAppDO dbApp01 = RandomUtils.randomPojo(PayAppDO.class);
        appMapper.insert(dbApp01);// @Sql: 先插入出一条存在的数据
        PayAppDO dbApp02 = RandomUtils.randomPojo(PayAppDO.class);
    ...
    public void testGetAppPage() {
        ...
        PayAppDO dbApp = RandomUtils.randomPojo(PayAppDO.class, o -> { // 等会查询到
    ...
    public void testValidPayApp_notFound() {
        ...
        assertServiceException(() -> appService.validPayApp(RandomUtils.randomLongId()), APP_NOT_FOUND);
