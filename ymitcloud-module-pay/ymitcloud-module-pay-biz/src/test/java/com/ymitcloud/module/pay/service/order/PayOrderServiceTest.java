package com.ymitcloud.module.pay.service.order;


import static com.ymitcloud.framework.test.core.util.RandomUtils.*;
import static com.ymitcloud.framework.common.util.date.LocalDateTimeUtils.*;
...
import com.ymitcloud.framework.pay.core.enums.order.PayOrderDisplayModeEnum;
import com.ymitcloud.framework.pay.core.enums.order.PayOrderStatusRespEnum;
import com.ymitcloud.framework.test.core.ut.BaseDbAndRedisUnitTest;
...
import com.ymitcloud.module.pay.dal.mysql.order.PayOrderExtensionMapper;
import com.ymitcloud.module.pay.dal.mysql.order.PayOrderMapper;
import com.ymitcloud.module.pay.dal.redis.no.PayNoRedisDAO;
import com.ymitcloud.module.pay.enums.notify.PayNotifyTypeEnum;
import com.ymitcloud.module.pay.enums.order.PayOrderStatusEnum;
import com.ymitcloud.module.pay.framework.pay.config.PayProperties;
...
import static com.ymitcloud.framework.common.util.json.JsonUtils.toJsonString;
...
import static com.ymitcloud.module.pay.enums.ErrorCodeConstants.*;
...
public class PayOrderServiceTest extends BaseDbAndRedisUnitTest {
    ...
    public void testCreateOrder_success() {
        ...
        PayOrderCreateReqDTO reqDTO = randomPojo(PayOrderCreateReqDTO.class,
                ...
                o -> o.setAppId(1L).setMerchantOrderId("10").setSubject(randomString()).setBody(randomString()));
    ...
    public void testSubmitOrder_expired() {
        ...
        PayOrderDO order = randomPojo(PayOrderDO.class,
                o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus()).setExpireTime(addTime(Duration.ofDays(-1))));
    ...
    public void testSubmitOrder_channelNotFound() {
        ...
        PayOrderSubmitReqVO reqVO = randomPojo(PayOrderSubmitReqVO.class,
                o -> o.setId(order.getId()).setChannelCode(PayChannelEnum.ALIPAY_APP.getCode()));
        ...
        when(channelService.validPayChannel(eq(1L), eq(PayChannelEnum.ALIPAY_APP.getCode()))).thenReturn(channel);
    ...
    public void testSubmitOrder_channelError() {
        ...
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            PayChannelDO channel = randomPojo(PayChannelDO.class,
                    o -> o.setId(10L).setCode(PayChannelEnum.ALIPAY_APP.getCode()));
            when(channelService.validPayChannel(eq(1L), eq(PayChannelEnum.ALIPAY_APP.getCode()))).thenReturn(channel);
            ...
            PayOrderRespDTO unifiedOrderResp = randomPojo(PayOrderRespDTO.class,
                    o -> o.setChannelErrorCode("001").setChannelErrorMsg("模拟异常"));
            ...
            assertServiceException(() -> orderService.submitOrder(reqVO, userIp), PAY_ORDER_SUBMIT_CHANNEL_ERROR, "001",
                    "模拟异常");
            ...
            assertThat(orderExtension).extracting("channelId", "channelCode", "userIp", "status", "channelExtras",
                    "channelErrorCode", "channelErrorMsg", "channelNotifyData").containsExactly(10L,
                            PayChannelEnum.ALIPAY_APP.getCode(), userIp, PayOrderStatusEnum.WAITING.getStatus(),
                            reqVO.getChannelExtras(), null, null, null);
    ...
    public void testSubmitOrder_success() {
        ...
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            PayOrderRespDTO unifiedOrderResp = randomPojo(PayOrderRespDTO.class,
                    o -> o.setChannelErrorCode(null).setChannelErrorMsg(null)
            ...
            assertThat(result).extracting("status", "displayMode", "displayContent").containsExactly(
                    PayOrderStatusEnum.WAITING.getStatus(), PayOrderDisplayModeEnum.URL.getMode(), "tudou");
    ...
    public void testValidateOrderActuallyPaid_dbPaid() {
        ...
        assertServiceException(() -> orderService.validateOrderActuallyPaid(id), PAY_ORDER_EXTENSION_IS_PAID);
    ...
    public void testValidateOrderActuallyPaid_remotePaid() {
        ...
        when(client.getOrder(eq(orderExtension.getNo()))).thenReturn(
                randomPojo(PayOrderRespDTO.class, o -> o.setStatus(PayOrderStatusEnum.SUCCESS.getStatus())));
    ...
    public void testValidateOrderActuallyPaid_success() {
        ...
        when(client.getOrder(eq(orderExtension.getNo()))).thenReturn(
                randomPojo(PayOrderRespDTO.class, o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus())));
    ...
    public void testNotifyOrderSuccess_orderExtension_notFound() {
        ...
        assertServiceException(() -> orderService.notifyOrder(channel, notify), PAY_ORDER_EXTENSION_NOT_FOUND);
    ...
    public void testNotifyOrderSuccess_orderExtension_closed() {
        ...
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                ...
                o -> o.setStatus(PayOrderStatusEnum.CLOSED.getStatus()).setNo("P110"));
        ...
        PayOrderRespDTO notify = randomPojo(PayOrderRespDTO.class,
                ...
                o -> o.setStatus(PayOrderStatusRespEnum.SUCCESS.getStatus()).setOutTradeNo("P110"));
    ...
    public void testNotifyOrderSuccess_order_notFound() {
        ...
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                ...
                o -> o.setStatus(PayOrderStatusEnum.SUCCESS.getStatus()).setNo("P110"));
        ...
        // 调用，并断言异常
        assertServiceException(() -> orderService.notifyOrder(channel, notify), PAY_ORDER_NOT_FOUND);
    ...
    private void testNotifyOrderSuccess_order_closedOrRefund(Integer status) {
        ...
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                ...
                o -> o.setStatus(PayOrderStatusEnum.SUCCESS.getStatus()).setNo("P110").setOrderId(order.getId()));
        ...
        // 调用，并断言异常
        assertServiceException(() -> orderService.notifyOrder(channel, notify), PAY_ORDER_STATUS_IS_NOT_WAITING);
    ...
    public void testNotifyOrderSuccess_order_waiting() {
        ...
        // mock 数据（PayOrderExtensionDO）
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus()).setNo("P110").setOrderId(order.getId()));
        orderExtensionMapper.insert(orderExtension);
        // 准备参数
        PayChannelDO channel = randomPojo(PayChannelDO.class, o -> o.setId(10L).setFeeRate(10D));
        PayOrderRespDTO notify = randomPojo(PayOrderRespDTO.class,
                o -> o.setStatus(PayOrderStatusRespEnum.SUCCESS.getStatus()).setOutTradeNo("P110"));
        ...
        orderExtension.setStatus(PayOrderStatusEnum.SUCCESS.getStatus()).setChannelNotifyData(toJsonString(notify));
        assertPojoEquals(orderExtension, orderExtensionMapper.selectOne(null), "updateTime", "updater");
        // 断言 PayOrderDO ：数据未更新，因为它是 SUCCESS
        order.setStatus(PayOrderStatusEnum.SUCCESS.getStatus()).setChannelId(10L).setChannelCode(channel.getCode())
                .setSuccessTime(notify.getSuccessTime()).setExtensionId(orderExtension.getId())
                .setNo(orderExtension.getNo()).setChannelOrderNo(notify.getChannelOrderNo())
                .setChannelUserId(notify.getChannelUserId()).setChannelFeeRate(10D).setChannelFeePrice(1);
    ...
    public void testNotifyOrderClosed_orderExtension_closed() {
        ...
        PayOrderRespDTO notify = randomPojo(PayOrderRespDTO.class,
                ...
                o -> o.setStatus(PayOrderStatusRespEnum.CLOSED.getStatus()).setOutTradeNo("P110"));
    ...
    public void testNotifyOrderClosed_orderExtension_refund() {
        ...
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                ...
                o -> o.setStatus(PayOrderStatusEnum.REFUND.getStatus()).setNo("P110"));
    ...
    public void testNotifyOrderClosed_orderExtension_waiting() {
        ...
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                ...
                o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus()).setNo("P110"));
    ...
    public void testUpdateOrderRefundPrice_notFound() {
        ...
        assertServiceException(() -> orderService.updateOrderRefundPrice(id, incrRefundPrice), PAY_ORDER_NOT_FOUND);
    ...
    public void testUpdateOrderRefundPrice_priceExceed() {
        ...
        PayOrderDO order = randomPojo(PayOrderDO.class,
                ...
                o -> o.setStatus(PayOrderStatusEnum.SUCCESS.getStatus()).setRefundPrice(1).setPrice(10));
        ...
        assertServiceException(() -> orderService.updateOrderRefundPrice(id, incrRefundPrice), REFUND_PRICE_EXCEED);
    ...
    private void testUpdateOrderRefundPrice_refundOrSuccess(Integer status) {
        ...
        PayOrderDO order = randomPojo(PayOrderDO.class, o -> o.setStatus(status).setRefundPrice(1).setPrice(10));
    ...
    public void testSyncOrder_payClientNotFound() {
        ...
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                ...
                o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus()).setCreateTime(LocalDateTime.now()));
    ...
    public void testSyncOrder_exception() {
        ...
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                ...
                o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus()).setChannelId(10L)
    ...
    public void testSyncOrder_orderSuccess() {
        ...
        try (MockedStatic<SpringUtil> springUtilMockedStatic = mockStatic(SpringUtil.class)) {
            ...
            PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                    ...
                    o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus()).setChannelId(10L).setNo("P110")
    ...
    public void testExpireOrder_orderExtension_isSuccess() {
        ...
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                o -> o.setStatus(PayOrderStatusEnum.SUCCESS.getStatus()).setOrderId(order.getId()));
    ...
    public void testExpireOrder_payClient_notFound() {
        ...
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus()).setOrderId(order.getId()).setChannelId(10L));
    ...
    public void testExpireOrder_getOrder_isRefund() {
        ...
        // mock 数据（PayOrderExtensionDO 等待中）
        PayOrderExtensionDO orderExtension = randomPojo(PayOrderExtensionDO.class,
                o -> o.setStatus(PayOrderStatusEnum.WAITING.getStatus()).setOrderId(order.getId()).setNo("P110")
    ...
    public void testExpireOrder_success() {
        ...
        orderExtension.setStatus(PayOrderStatusEnum.CLOSED.getStatus()).setChannelNotifyData(toJsonString(respDTO));
        assertPojoEquals(orderExtension, orderExtensionMapper.selectOne(null), "updateTime", "updater");
        // 断言 order 变化
