package com.ymitcloud.module.pay.framework.pay.config;
...
@ConfigurationProperties(prefix = "ymitcloud.pay")
...
public class PayProperties {
     ...
     * 回调顺序：支付渠道（支付宝支付、微信支付） => ymitcloud-module-pay 的 orderNotifyUrl 地址 => 业务的 PayAppDO.orderNotifyUrl 地址
     ...
     * 回调顺序：支付渠道（支付宝支付、微信支付） => ymitcloud-module-pay 的 refundNotifyUrl 地址 => 业务的 PayAppDO.notifyRefundUrl 地址
