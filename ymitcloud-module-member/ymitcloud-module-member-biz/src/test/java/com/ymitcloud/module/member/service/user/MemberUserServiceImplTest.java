package com.ymitcloud.module.member.service.user;
...
import com.ymitcloud.module.member.dal.mysql.user.MemberUserMapper;
import com.ymitcloud.module.member.service.auth.MemberAuthServiceImpl;
import com.ymitcloud.module.system.api.sms.SmsCodeApi;
...
@Import({MemberUserServiceImpl.class, YmitcloudRedisAutoConfiguration.class})
...
//        when(smsCodeService.checkCodeIsExpired(codeDO.getMobile(),codeDO.getCode(),codeDO.getScene())).thenReturn(codeDO);
        ...
        Assertions.assertEquals(memberUserService.getUser(userDO.getId()).getMobile(),newMobile);
    }
