package com.ymitcloud.module.member.service.tag;
...
import com.ymitcloud.module.member.dal.mysql.tag.MemberTagMapper;
...
public class MemberTagServiceImplTest extends BaseDbUnitTest {
    ...
    public void testUpdateTag_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> tagService.updateTag(reqVO), ErrorCodeConstants.TAG_NOT_EXISTS);
    }
    ...
    public void testDeleteTag_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> tagService.deleteTag(id), ErrorCodeConstants.TAG_NOT_EXISTS);
    }
