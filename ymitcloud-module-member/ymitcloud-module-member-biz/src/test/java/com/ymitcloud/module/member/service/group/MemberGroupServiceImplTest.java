package com.ymitcloud.module.member.service.group;
...
import com.ymitcloud.module.member.dal.mysql.group.MemberGroupMapper;
...
public class MemberGroupServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateGroup_success() {
        ...
        MemberGroupCreateReqVO reqVO = RandomUtils.randomPojo(MemberGroupCreateReqVO.class,
    ...
    public void testUpdateGroup_success() {
        ...
        MemberGroupDO dbGroup = RandomUtils.randomPojo(MemberGroupDO.class);
        groupMapper.insert(dbGroup);// @Sql: 先插入出一条存在的数据
        // 准备参数
        MemberGroupUpdateReqVO reqVO = RandomUtils.randomPojo(MemberGroupUpdateReqVO.class, o -> {
    ...
    public void testUpdateGroup_notExists() {
        ...
        MemberGroupUpdateReqVO reqVO = RandomUtils.randomPojo(MemberGroupUpdateReqVO.class);


        // 调用, 并断言异常
        assertServiceException(() -> groupService.updateGroup(reqVO), ErrorCodeConstants.GROUP_NOT_EXISTS);
    }
    ...
    public void testDeleteGroup_notExists() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> groupService.deleteGroup(id), ErrorCodeConstants.GROUP_NOT_EXISTS);
    }
    ...
    public void testDeleteGroup_hasUser() {
        ...
        // 调用, 并断言异常
        assertServiceException(() -> groupService.deleteGroup(id), ErrorCodeConstants.GROUP_HAS_USER);
    }
    ...
    public void testGetGroupPage() {
        ...
        // mock 数据
        MemberGroupDO dbGroup = RandomUtils.randomPojo(MemberGroupDO.class, o -> { // 等会查询到
