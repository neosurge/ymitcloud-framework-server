package com.ymitcloud.module.product.service.spu;
...
import com.ymitcloud.module.product.controller.admin.spu.vo.*;
...
import com.ymitcloud.module.product.dal.mysql.spu.ProductSpuMapper;
...
import static com.ymitcloud.framework.common.util.collection.CollectionUtils.getSumValue;
...
public class ProductSpuServiceImpl implements ProductSpuService {
    ...
    private void initSpuFromSkus(ProductSpuDO spu, List<ProductSkuCreateOrUpdateReqVO> skus) {
        ...
        // sku 单价最低的商品的条形码 TODO 云码：条形码字段，是不是可以删除
