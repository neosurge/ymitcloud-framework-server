...
import com.ymitcloud.module.promotion.api.coupon.CouponApi;
...
import com.ymitcloud.module.trade.framework.order.config.TradeOrderConfig;
...
//        MemberAddressRespDTO addressRespDTO = new MemberAddressRespDTO().setId(10L).setUserId(userId).setName("云码")
...
//        assertEquals(tradeOrderDO.getReceiverName(), "云码");
