...
import com.ymitcloud.module.pay.enums.DictTypeConstants;
import com.ymitcloud.module.product.api.comment.dto.ProductCommentCreateReqDTO;
import com.ymitcloud.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
...
import com.ymitcloud.module.trade.controller.app.order.vo.AppOrderExpressTrackRespDTO;
...
import com.ymitcloud.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
public interface TradeOrderConvert {
    ...
    default PayOrderCreateReqDTO convert(TradeOrderDO order, List<TradeOrderItemDO> orderItems,
        ...
        createReqDTO.setBody(subject); // TODO 云码：临时写死
