package com.ymitcloud.module.statistics.service.member;
...
import com.ymitcloud.framework.ip.core.enums.AreaTypeEnum;
...
import com.ymitcloud.module.statistics.dal.mysql.member.MemberStatisticsMapper;
...
public class MemberStatisticsServiceImpl implements MemberStatisticsService {
    ...
    public List<MemberAreaStatisticsRespVO> getMemberAreaStatisticsList() {
        ...
        Map<Integer, Integer> userCountMap = CollectionUtils.convertMap(memberStatisticsMapper.selectSummaryListByAreaId(),
