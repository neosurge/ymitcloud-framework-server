package com.ymitcloud.module.promotion.service.diy;
...
import com.ymitcloud.module.promotion.dal.mysql.diy.DiyTemplateMapper;
...
public class DiyTemplateServiceImpl implements DiyTemplateService {
    ...
    void validateNameUnique(Long id, String name) {
        ...
        if (id == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.DIY_TEMPLATE_NAME_USED, name);
        }
    ...
    public void deleteDiyTemplate(Long id) {
        ...
        if (BooleanUtil.isTrue(diyTemplateDO.getUsed())) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.DIY_TEMPLATE_USED_CANNOT_DELETE);
        }
        // 删除
    ...
    private DiyTemplateDO validateDiyTemplateExists(Long id) {
        ...
        if (diyTemplateDO == null) {
            throw ServiceExceptionUtil.exception(ErrorCodeConstants.DIY_TEMPLATE_NOT_EXISTS);
        }
