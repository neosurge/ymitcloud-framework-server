...
import com.ymitcloud.module.promotion.dal.mysql.combination.CombinationActivityMapper;
import com.ymitcloud.module.promotion.dal.mysql.combination.CombinationProductMapper;
...
public class CombinationActivityServiceImpl implements CombinationActivityService {
    ...
    public Long createCombinationActivity(CombinationActivityCreateReqVO createReqVO) {
        ...
        List<CombinationProductDO> products = CombinationActivityConvert.INSTANCE.convertList(createReqVO.getProducts(),
                activity);
    ...
    private void validateProductConflict(Long spuId, Long activityId) {
        ...
        List<CombinationActivityDO> activityList = combinationActivityMapper
        ...
        List<CombinationActivityDO> matchActivityList = CollectionUtils.filterList(activityList,
                activity -> ObjectUtil.equal(activity.getId(), spuId));
    ...
    public void closeCombinationActivityById(Long id) {
        ...
        combinationActivityMapper
                .updateById(new CombinationActivityDO().setId(id).setStatus(CommonStatusEnum.DISABLE.getStatus()));
    ...
    private void updateCombinationProduct(CombinationActivityDO activity, List<CombinationProductBaseVO> products) {
        ...
        List<CombinationProductDO> oldList = combinationProductMapper
                .selectListByActivityIds(CollUtil.newArrayList(activity.getId()));
        ...
        if (CollUtil.isNotEmpty(diffList.get(2))) {
            ...
            combinationProductMapper
                    .deleteBatchIds(CollectionUtils.convertList(diffList.get(2), CombinationProductDO::getId));
    ...
    public void deleteCombinationActivity(Long id) {
        ...
        if (CommonStatusEnum.isEnable(activity.getStatus())) {
            ...
            throw ServiceExceptionUtil
                    .exception(ErrorCodeConstants.COMBINATION_ACTIVITY_DELETE_FAIL_STATUS_NOT_CLOSED_OR_END);
    ...
    public CombinationProductDO selectByActivityIdAndSkuId(Long activityId, Long skuId) {
        ...
        return combinationProductMapper.selectOne(CombinationProductDO::getActivityId, activityId,
    ...
    public List<CombinationActivityDO> getCombinationActivityBySpuIdsAndStatusAndDateTimeLt(Collection<Long> spuIds,
            Integer status, LocalDateTime dateTime) {
        // 1.查询出指定 spuId 的 spu 参加的活动最接近现在的一条记录。多个的话，一个 spuId 对应一个最近的活动编号
        List<Map<String, Object>> spuIdAndActivityIdMaps = combinationActivityMapper
