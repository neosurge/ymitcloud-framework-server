package com.ymitcloud.module.promotion.service.combination;
...
import com.ymitcloud.module.promotion.dal.mysql.combination.CombinationRecordMapper;
...
import static com.ymitcloud.framework.common.util.date.LocalDateTimeUtils.afterNow;
import static com.ymitcloud.framework.common.util.date.LocalDateTimeUtils.beforeNow;


// TODO 云码：等拼团记录做完，完整 review 下
...
public class CombinationRecordServiceImpl implements CombinationRecordService {
    ...
    // TODO @云码：在详细预览下；
    @Override
    public KeyValue<CombinationActivityDO, CombinationProductDO> validateCombinationRecord(Long userId, Long activityId,
            Long headId, Long skuId, Integer count) {
        ...
        if (count > activity.getSingleLimitCount()) {
            ...
            throw ServiceExceptionUtil
                    .exception(ErrorCodeConstants.COMBINATION_RECORD_FAILED_SINGLE_LIMIT_COUNT_EXCEED);
        ...
        if (headId != null) {
            ...
            CombinationRecordDO record = combinationRecordMapper.selectByHeadId(headId,
                    CombinationRecordStatusEnum.IN_PROGRESS.getStatus());
        ...
        List<CombinationRecordDO> recordList = combinationRecordMapper.selectListByUserIdAndActivityId(userId,
                activityId);
        ...
        CombinationRecordDO inProgressRecord = CollectionUtils.findFirst(recordList,
        ...
        Integer sumValue = CollectionUtils.getSumValue(recordList, CombinationRecordDO::getCount, Integer::sum);
    ...
    public CombinationRecordDO createCombinationRecord(CombinationRecordCreateReqDTO reqDTO) {
        ...
        CombinationRecordDO record = CombinationActivityConvert.INSTANCE.convert(reqDTO, keyValue.getKey(), user, spu,
                sku);
    ...
    public CombinationValidateJoinRespDTO validateJoinCombination(Long userId, Long activityId, Long headId, Long skuId,
            Integer count) {
    ...
    public Map<Long, Integer> getCombinationRecordCountMapByActivity(Collection<Long> activityIds,
        ...
        return combinationRecordMapper.selectCombinationRecordCountMapByActivityIdAndStatusAndHeadId(activityIds,
                status, headId);
    ...
    public CombinationRecordDO getCombinationRecordByIdAndUser(Long userId, Long id) {
        ...
        return combinationRecordMapper.selectOne(CombinationRecordDO::getUserId, userId, CombinationRecordDO::getId,
                id);
    ...
    public KeyValue<Integer, Integer> expireCombinationRecord() {
        ...
        List<CombinationRecordDO> headExpireRecords = combinationRecordMapper
                .selectListByHeadIdAndStatusAndExpireTimeLt(CombinationRecordDO.HEAD_ID_GROUP,
                        CombinationRecordStatusEnum.IN_PROGRESS.getStatus(), LocalDateTime.now());
        ...
        List<CombinationActivityDO> activities = combinationActivityService.getCombinationActivityListByIds(
                ...
                CollectionUtils.convertSet(headExpireRecords, CombinationRecordDO::getActivityId));
        ...
        for (CombinationRecordDO record : headExpireRecords) {
            try {
                ...
                log.error("[expireCombinationRecord][record({}) 处理异常，请进行处理！record 数据是：{}]", record.getId(),
    ...
    private List<CombinationRecordDO> updateBatchCombinationRecords(CombinationRecordDO headRecord,
            CombinationRecordStatusEnum status) {
