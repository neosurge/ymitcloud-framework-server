...
import com.ymitcloud.module.promotion.controller.app.coupon.vo.template.AppCouponTemplatePageReqVO;
import com.ymitcloud.module.promotion.controller.app.coupon.vo.template.AppCouponTemplateRespVO;
...
public class AppCouponTemplateController {
     ...
     */
    @GetMapping("/page")
    public CommonResult<PageResult<AppCouponTemplateRespVO>> getCouponTemplatePage(
            AppCouponTemplatePageReqVO pageReqVO) {
        ...
        PageResult<CouponTemplateDO> pageResult = couponTemplateService
                .getCouponTemplatePage(CouponTemplateConvert.INSTANCE.convert(pageReqVO, canTakeTypes,
                        pageReqVO.getProductScope(), productScopeValue));
