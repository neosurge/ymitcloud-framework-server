...
import com.ymitcloud.module.system.dal.dataobject.sms.SmsCodeDO;
import com.ymitcloud.module.system.dal.mysql.sms.SmsCodeMapper;
import com.ymitcloud.module.system.enums.sms.SmsSceneEnum;
import com.ymitcloud.module.system.framework.sms.SmsCodeProperties;
...
import static com.ymitcloud.framework.common.util.date.DateUtils.isToday;
...
public class SmsCodeServiceImpl implements SmsCodeService {
    ...
    private String createSmsCode(String mobile, Integer scene, String ip) {
        ...
        if (lastSmsCode != null) {
            ...
            // TODO 云码：提升，每个 IP 每天可发送数量
            // TODO 云码：提升，每个 IP 每小时可发送数量
        }
