...
import com.ymitcloud.module.system.dal.mysql.social.SocialClientMapper;
...
public class SocialClientServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetAuthorizeUrl() {
        try (MockedStatic<AuthStateUtils> authStateUtilsMock = mockStatic(AuthStateUtils.class)) {
            ...
            when(authRequest.authorize(eq("aoteman"))).thenReturn("https://www.ymitcloud.com?redirect_uri=yyy");
            ...
            assertEquals("https://www.ymitcloud.com?redirect_uri=sss", url);
