...
import com.ymitcloud.module.system.dal.mysql.mail.MailTemplateMapper;
...
import static com.ymitcloud.module.system.enums.ErrorCodeConstants.MAIL_TEMPLATE_NOT_EXISTS;
...
public class MailTemplateServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMailTemplatePage() {
        ...
        mailTemplateMapper.insert(cloneIgnoreId(dbMailTemplate, o -> o.setName("云码")));
