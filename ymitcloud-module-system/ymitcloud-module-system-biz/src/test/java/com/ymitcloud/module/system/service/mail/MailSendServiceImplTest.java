package com.ymitcloud.module.system.service.mail;
...
import com.ymitcloud.module.system.mq.message.mail.MailSendMessage;
import com.ymitcloud.module.system.mq.producer.mail.MailProducer;
...
//                .setFrom("奥特曼 <ydym_test@163.com>")
    ...
    public void testDoSendMail_success() {
        try (final MockedStatic<MailUtil> mailUtilMock = mockStatic(MailUtil.class)) {
            ...
            MailSendMessage message = randomPojo(MailSendMessage.class, o -> o.setNickname("云码"));
            ...
            mailUtilMock.when(() -> MailUtil.send(
                    argThat(mailAccount -> {
                        ...
                        assertEquals("云码 <7685@qq.com>", mailAccount.getFrom());
