package com.ymitcloud.module.system.service.user;
...
import com.ymitcloud.module.infra.api.file.FileApi;
...
import com.ymitcloud.module.system.controller.admin.user.vo.user.*;
...
import com.ymitcloud.module.system.dal.dataobject.dept.UserPostDO;
...
import com.ymitcloud.module.system.dal.mysql.dept.UserPostMapper;
import com.ymitcloud.module.system.dal.mysql.user.AdminUserMapper;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("ymitcloud");
        ...
        assertEquals("ymitcloud", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(passwordEncoder.encode(eq("ymitcloud"))).thenReturn("java");
