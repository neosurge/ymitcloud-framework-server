package com.ymitcloud.module.system.service.tenant;

import com.ymitcloud.framework.common.enums.CommonStatusEnum;
import com.ymitcloud.framework.common.pojo.PageResult;
import com.ymitcloud.framework.tenant.config.TenantProperties;
...
import com.ymitcloud.module.system.dal.mysql.tenant.TenantMapper;
import com.ymitcloud.module.system.enums.permission.RoleCodeEnum;
import com.ymitcloud.module.system.enums.permission.RoleTypeEnum;
...
import com.ymitcloud.module.system.service.tenant.handler.TenantInfoHandler;
import com.ymitcloud.module.system.service.tenant.handler.TenantMenuHandler;
...
import static com.ymitcloud.framework.common.util.collection.SetUtils.asSet;
...
import static com.ymitcloud.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;

import static com.ymitcloud.framework.test.core.util.RandomUtils.*;

import static com.ymitcloud.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("云码", user.getNickname());
        ...
        TenantSaveReqVO reqVO = randomPojo(TenantSaveReqVO.class, o -> {
            ...
            o.setWebsite("https://www.ymitcloud.com");
    ...
    public void testGetTenantByName() {
        ...
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("云码"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("云码");
    ...
    public void testGetTenantByWebsite() {
        ...
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setWebsite("https://www.ymitcloud.com"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByWebsite("https://www.ymitcloud.com");
