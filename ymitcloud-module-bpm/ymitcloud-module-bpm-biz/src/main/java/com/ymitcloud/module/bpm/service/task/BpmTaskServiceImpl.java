...
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.PROCESS_INSTANCE_NOT_EXISTS;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_ADD_SIGN_TYPE_ERROR;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_ADD_SIGN_USER_NOT_EXIST;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_ADD_SIGN_USER_REPEAT;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_DELEGATE_FAIL_USER_NOT_EXISTS;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_DELEGATE_FAIL_USER_REPEAT;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_IS_PENDING;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_NOT_EXISTS;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_OPERATE_FAIL_ASSIGN_NOT_SELF;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_RETURN_FAIL_SOURCE_TARGET_ERROR;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_SUB_SIGN_NO_PARENT;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.TASK_TARGET_NODE_NOT_EXISTS;
...
import com.ymitcloud.framework.flowable.core.util.BpmnModelUtils;
...
import com.ymitcloud.module.bpm.convert.task.BpmTaskConvert;
import com.ymitcloud.module.bpm.dal.dataobject.task.BpmTaskExtDO;
import com.ymitcloud.module.bpm.dal.mysql.task.BpmTaskExtMapper;
import com.ymitcloud.module.bpm.enums.task.BpmCommentTypeEnum;
import com.ymitcloud.module.bpm.enums.task.BpmProcessInstanceDeleteReasonEnum;
import com.ymitcloud.module.bpm.enums.task.BpmProcessInstanceResultEnum;
import com.ymitcloud.module.bpm.enums.task.BpmTaskAddSignTypeEnum;
import com.ymitcloud.module.bpm.service.definition.BpmModelService;
import com.ymitcloud.module.bpm.service.message.BpmMessageService;
...
public class BpmTaskServiceImpl implements BpmTaskService {
    ...
    public void returnTask0(Task currentTask, FlowElement targetElement, BpmTaskReturnReqVO reqVO) {
        ...
        List<String> runTaskKeyList = CollectionUtils.convertList(taskList, Task::getTaskDefinitionKey);
        ...
        List<String> returnTaskKeyList = CollectionUtils.convertList(returnUserTaskList, UserTask::getId);
    ...
    public void createSignTask(Long userId, BpmTaskAddSignReqVO reqVO) {
        ...
        createSignTask(CollectionUtils.convertList(reqVO.getUserIdList(), String::valueOf), taskEntity);
        ...
        String comment = StrUtil.format(BpmCommentTypeEnum.ADD_SIGN.getComment(), currentUser.getNickname(),
                ...
                BpmTaskAddSignTypeEnum.formatDesc(reqVO.getType()), String.join(",", CollectionUtils.convertList(userList, AdminUserRespDTO::getNickname)), reqVO.getReason());
    ...
    private TaskEntityImpl validateAddSign(Long userId, BpmTaskAddSignReqVO reqVO) {
        ...
        List<Long> currentAssigneeList = CollectionUtils.convertList(taskList, task -> NumberUtils.parseLong(task.getAssignee()));
        ...
        if (CollUtil.isNotEmpty(currentAssigneeList)) {
            ...
            throw exception(TASK_ADD_SIGN_USER_REPEAT, String.join(",", CollectionUtils.convertList(userList, AdminUserRespDTO::getNickname)));
    ...
    private List<String> getChildrenTaskIdList(String parentTaskId) {
        ...
        return CollectionUtils.convertList(getChildrenTaskList0(parentTaskId), Task::getId);
    ...
    public List<BpmTaskSubSignRespVO> getChildrenTaskList(String parentId) {
        ...
        List<String> childrenTaskIdList = CollectionUtils.convertList(taskList, Task::getId);

        // 2.1 将 owner 和 assignee 统一到一个集合中
        List<Long> userIds = CollectionUtils.convertListByFlatMap(taskList, control ->
        ...
        Map<String, Task> idTaskMap = CollectionUtils.convertMap(taskList, TaskInfo::getId);
