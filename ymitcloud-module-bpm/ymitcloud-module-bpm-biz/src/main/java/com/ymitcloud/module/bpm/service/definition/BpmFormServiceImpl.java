...
import com.ymitcloud.module.bpm.dal.mysql.definition.BpmFormMapper;
import com.ymitcloud.module.bpm.enums.ErrorCodeConstants;
import com.ymitcloud.module.bpm.enums.definition.BpmModelFormTypeEnum;
import com.ymitcloud.module.bpm.service.definition.dto.BpmFormFieldRespDTO;
import com.ymitcloud.module.bpm.service.definition.dto.BpmModelMetaInfoRespDTO;
...
public class BpmFormServiceImpl implements BpmFormService {
    ...
    private void checkFields(List<String> fields) {
        ...
        if (true) { // TODO 云码：兼容 Vue3 工作流：因为采用了新的表单设计器，所以暂时不校验
