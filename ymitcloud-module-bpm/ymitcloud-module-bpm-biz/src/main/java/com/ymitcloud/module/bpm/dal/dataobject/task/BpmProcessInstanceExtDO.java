package com.ymitcloud.module.bpm.dal.dataobject.task;
...
import com.ymitcloud.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
...
public class BpmProcessInstanceExtDO extends BaseDO {
    ...
    @TableField(typeHandler = JacksonTypeHandler.class, exist = false) // TODO 云码：临时 exist = false，避免 db 报错；
