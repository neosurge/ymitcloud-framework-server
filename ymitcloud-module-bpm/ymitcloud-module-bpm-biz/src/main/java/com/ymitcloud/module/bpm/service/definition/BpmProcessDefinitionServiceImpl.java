package com.ymitcloud.module.bpm.service.definition;
...
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.PROCESS_DEFINITION_KEY_NOT_MATCH;
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.PROCESS_DEFINITION_NAME_NOT_MATCH;
...
import com.ymitcloud.module.bpm.convert.definition.BpmProcessDefinitionConvert;
import com.ymitcloud.module.bpm.dal.dataobject.definition.BpmFormDO;
import com.ymitcloud.module.bpm.dal.dataobject.definition.BpmProcessDefinitionExtDO;
import com.ymitcloud.module.bpm.dal.mysql.definition.BpmProcessDefinitionExtMapper;
import com.ymitcloud.module.bpm.service.definition.dto.BpmProcessDefinitionCreateReqDTO;
...
public class BpmProcessDefinitionServiceImpl implements BpmProcessDefinitionService {
    ...
    public String createProcessDefinition(@Valid BpmProcessDefinitionCreateReqDTO createReqDTO) {
        ...
        Deployment deploy = repositoryService.createDeployment().key(createReqDTO.getKey()).name(createReqDTO.getName())
                .category(createReqDTO.getCategory())
                .addBytes(createReqDTO.getKey() + BPMN_FILE_SUFFIX, createReqDTO.getBpmnBytes())
                .tenantId(TenantContextHolder.getTenantIdStr()).deploy();
        ...
        // 注意 1，ProcessDefinition 的 key 和 name 是通过 BPMN 中的 <bpmn2:process /> 的 id 和 name
        // 决定
    ...
    public boolean isProcessDefinitionEquals(@Valid BpmProcessDefinitionCreateReqDTO createReqDTO) {
        ...
        if (!ObjectUtil.equal(createReqDTO.getFormType(), oldProcessDefinitionExt.getFormType())
                ...
                || !ObjectUtil.equal(createReqDTO.getFormCustomCreatePath(),
                        oldProcessDefinitionExt.getFormCustomCreatePath())
                || !ObjectUtil.equal(createReqDTO.getFormCustomViewPath(),
    ...
    public PageResult<BpmProcessDefinitionPageItemRespVO> getProcessDefinitionPage(
            BpmProcessDefinitionPageReqVO pageVO) {
        ...
        processDefinitions
                .forEach(definition -> CollectionUtils.addIfNotNull(deploymentIds, definition.getDeploymentId()));
