...
import com.ymitcloud.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static com.ymitcloud.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("云码")));
