...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.ymitcloud.boot";
    private static final String ARTIFACT_ID = "ymitcloud";
    private static final String PACKAGE_NAME = "com.ymitcloud";
    private static final String TITLE = "云码管理系统";
